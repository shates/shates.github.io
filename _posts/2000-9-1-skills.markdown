...
2. Bioinformatics
- Analyzing sequencing results using the Galaxy Platform and phylogenetic analyses using Qiagen CLC Main Bench. Some experience with [MEGAX](https://www.megasoftware.net/) and [PopART](http://popart.otago.ac.nz/documentation.shtml). 
3. Field skills 
